...
// ─────────────────────────────────────────────────────────────
const BUY_LINK = "https://ravirama.gumroad.com/l/rnhpl";
    ...
    <div className="min-h-screen bg-[#F7F9FC]" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      <section className="max-w-2xl mx-auto px-6 pb-20">
        <div className="bg-white rounded-2xl ring-1 ring-slate-200 p-8 text-center shadow-sm">
          <div className="text-xs font-bold text-[#1E5A8A] uppercase tracking-widest mb-2">Monthly Subscription</div>
          <div className="text-5xl font-bold text-[#0F1B2D] mb-1" style={{ fontFamily: "Sora, sans-serif" }}>$10<span className="text-lg text-slate-400 font-medium">/mo</span></div>
          <div className="text-sm text-slate-400 mb-6">Billed monthly — cancel anytime</div>
          <ul className="text-left max-w-xs mx-auto space-y-2.5 mb-7">
            {["Full accounting template", "Built-in automation menu", "Ongoing updates & new features", "Priority setup support"].map(item => (
